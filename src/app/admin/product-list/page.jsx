...
const ProductList = () => {
  ...
  const deleteProduct = async (productId) => {
    ...
    // Use mock data
    try {
      const idx = productsDummyData.findIndex(p => p._id === productId);
      if (idx !== -1) {
        productsDummyData.splice(idx, 1);
        setProducts(productsDummyData.slice());
  ...
  useEffect(() => {
    const fetchSellerProduct = async () => {
      ...
      try {
        ...
        console.log("An error occurred while fetching products (mock).");
      }
    };
    fetchSellerProduct();
